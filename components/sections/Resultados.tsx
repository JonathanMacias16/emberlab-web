...
import { SlideIn, FadeIn, AnimatedDivider } from "@/components/animations";
  ...
  return (
    ...
    >
      <div className="mr-0 md:mr-[30%]">
        ...
        <AnimatedDivider origin="right" className="mt-4 sm:mt-6 h-[3px] md:h-1 w-full bg-[var(--purple-light)]" />
      </div>
    </section>
  );
}
