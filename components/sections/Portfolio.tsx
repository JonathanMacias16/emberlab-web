            ...
            <div className="w-full aspect-square rounded-2xl md:rounded-3xl lg:rounded-[46px] overflow-hidden relative">
              ...
              <div className="absolute inset-0 flex items-end p-4 sm:p-5 md:p-6 lg:p-8">
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full">
                  <span className="inline-flex items-center rounded-full border border-(--white) px-3 sm:px-4 md:px-5 py-1 sm:py-1.5 md:py-2 text-(--white) text-xs sm:text-sm md:text-base font-light">
                    {project.title}
                  </span>
                  <span className="inline-flex items-center rounded-full border border-(--white) px-3 sm:px-4 py-1 sm:py-1.5 md:py-2 text-[var(--white)] text-xs sm:text-sm md:text-base font-light hover:bg-(--white) hover:text-(--purple) transition-colors cursor-pointer">
                    Ver sitio
                  </span>
                </div>
              </div>
