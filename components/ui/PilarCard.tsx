export default function PilarCard({
  ...
  return (
    ...
    >
      <h3
        className={`${textColor} text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold tracking-[-0.04em] leading-[1.1]`}
      >
        {title}
      </h3>
      <p
        className={`${textColor} text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold tracking-[-0.04em] leading-[1.2] mt-4`}
      >
        {description}
      </p>
    </div>
