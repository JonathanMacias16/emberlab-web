...
function LogoIcon({ size = 32, color = "#E73F40" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 118 118" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M117.887 54.8743L0 56.397L0.0866161 63.1032L117.974 61.5805L117.887 54.8743Z" fill={color}/>
      <path d="M61.5786 5.09713e-05L54.8726 0.0866699L56.3952 117.978L63.1012 117.891L61.5786 5.09713e-05Z" fill={color}/>
      <path d="M27.6311 23.9622L94.8298 89.0161L90.1475 93.8213L22.9487 28.7673L27.6311 23.9622Z" fill={color}/>
      <path d="M86.3956 35.0651L36.7198 86.8792L31.9148 82.1967L81.5905 30.3826L86.3956 35.0651Z" fill={color}/>
    </svg>
  );
}
